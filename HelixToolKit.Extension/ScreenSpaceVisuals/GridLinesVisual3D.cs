...
namespace HelixToolKit.Extension
{
    ...
    public class GridLinesVisual3D : ModelVisual3D
    {
        ...
        public static readonly DependencyProperty DistanceProperty = DependencyProperty.Register(
            "MinorDistance", typeof(double), typeof(GridLinesVisual3D), new PropertyMetadata(1.0, GeometryChanged));
        ...
        public static readonly DependencyProperty LengthProperty = DependencyProperty.Register(
            "Length", typeof(double), typeof(GridLinesVisual3D), new PropertyMetadata(100.0, GeometryChanged));
        ...
        public static readonly DependencyProperty MajorLineColorProperty = DependencyProperty.Register(
            "MajorLineColor", typeof(Color), typeof(GridLinesVisual3D), new UIPropertyMetadata(Color.FromRgb(140, 140, 140)));
        ...
        public static readonly DependencyProperty MajorLineThicknessProperty =
            DependencyProperty.Register(
                "MajorLineThickness", typeof(double), typeof(GridLinesVisual3D), new UIPropertyMetadata(1.2));
        ...
        public static readonly DependencyProperty MinorLineColorProperty = DependencyProperty.Register(
            "MinorLineColor", typeof(Color), typeof(GridLinesVisual3D), new UIPropertyMetadata(Color.FromRgb(150, 150, 150)));
        ...
        public static readonly DependencyProperty MinorLineThicknessProperty =
            DependencyProperty.Register(
                "MinorLineThickness", typeof(double), typeof(GridLinesVisual3D), new UIPropertyMetadata(1.0));
        ...
        public static readonly DependencyProperty WidthProperty = DependencyProperty.Register(
            "Width", typeof(double), typeof(GridLinesVisual3D), new PropertyMetadata(100.0, GeometryChanged));
        ...
        public static readonly DependencyProperty XAxisLineColorProperty = DependencyProperty.Register(
            "XAxisLineColor", typeof(Color), typeof(GridLinesVisual3D), new UIPropertyMetadata(Color.FromRgb(150, 75, 75)));
        ...
        public static readonly DependencyProperty YAxisLineColorProperty = DependencyProperty.Register(
            "YAxisLineColor", typeof(Color), typeof(GridLinesVisual3D), new UIPropertyMetadata(Color.FromRgb(75, 150, 75)));
        ...
        public static readonly DependencyProperty ZAxisLineColorProperty = DependencyProperty.Register(
            "ZAxisLineColor", typeof(Color), typeof(GridLinesVisual3D), new UIPropertyMetadata(Color.FromRgb(75, 75, 150)));
