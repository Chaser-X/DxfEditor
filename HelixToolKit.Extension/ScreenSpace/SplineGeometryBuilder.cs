...
{
    public class SplineGeometryBuilder : ScreenGeometryBuilder
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SplineGeometryBuilder"/> class.
        /// </summary>
        /// <param name="visual">
        /// The visual parent of the geometry (the transform is calculated from this object).
        /// </param>
        public SplineGeometryBuilder(Visual3D visual)
            :base(visual)
        {
